...
* You will be introduced to processing of scRNA-seq data, pathway analysis, and basics of unsupervised machine learning through a series of hands-on exercises.
...
You can use the training-specific private channel to [post errors](./posting-error-guidelines.md), get help with debugging, and interact with other participants as they work through exercises.
We recommend you follow the [posting for error help guidelines](./posting-error-guidelines.md) so you can maximize others' abilities to help you resolve your error.
