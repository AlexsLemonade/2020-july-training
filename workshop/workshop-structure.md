...
You can use the training-specific private channel to [post errors](./posting-error-example.md), get help with debugging, and interact with other participants as they work through exercises.
We recommend you follow the [posting for error help guidelines](./posting-error-example.md) so you can maximize others' abilities to help you resolve your error.
