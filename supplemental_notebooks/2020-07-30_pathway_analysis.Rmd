...
Without specifying a coefficient, `topTable()` will report the F-statistics for testing whether any of the contrasts (treatment in Group 3, treatment in Group 4, and differences in response between the subtypes) are non-zero.
